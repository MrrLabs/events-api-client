...
class TaskRecordSchema(BaseModel):
    """
    Schema for individual task record.
    """ # noqa: E501
    platform: StrictStr = Field(description="Platform name")
    task_type: StrictStr = Field(description="Task type")
    message: Optional[StrictStr] = None
    timestamp: datetime = Field(description="Task completion/creation timestamp")
    started_at: Optional[datetime] = None
    finished_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["platform", "task_type", "message", "timestamp", "started_at", "finished_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskRecordSchema from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskRecordSchema from a dict"""
        if obj is None:
            return None
